...
package br.com.squassoni.connect.parser;
...
public abstract class FirstTransform<R extends ConnectRecord<R>> implements Transformation<R> {
...
//      String RENAME = "renames";
    ...
    public static final ConfigDef CONFIG_DEF = new ConfigDef()
    		.define(ConfigName.PARSER, ConfigDef.Type.INT, ConfigDef.Importance.MEDIUM,"Fields to exclude. This takes precedence over the whitelist.");
...
//    private Map<String, String> reverseRenames;
    ...
    public void configure(Map<String, ?> configs) {
        ...
        parser = config.getInt(ConfigName.PARSER);
...
//                               
//                updatedValue.put(fieldName, fieldValue.toString().substring(0,3));
//            //}
//        }
        
        final String updatedValue = operatingValue(record).toString().substring(0,parser);
    	
        //final String updatedValue = record.toString().substring(0,5);
...
//            }
    ...
    public static class Key<R extends ConnectRecord<R>> extends FirstTransform<R> {
    ...
    public static class Value<R extends ConnectRecord<R>> extends FirstTransform<R> {
